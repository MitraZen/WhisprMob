            ...
            >
              ...
              <View style={styles.field}>
                ...
                <TouchableOpacity
                  style={[
                    styles.dateButton,
                    isGettingLocation && styles.dateButtonDisabled,
                  ]}
                ...
                <Text style={styles.locationHint}>
                  Tap to automatically detect your country based on your current
                  location
                </Text>
              </View>
                    ...
                    {Platform.OS === 'ios' ? (
                      <View style={styles.datePickerContainer}>
                        ...
                        <View style={styles.datePickerActions}>
                          ...
                          >
                            <Text style={styles.datePickerSelectText}>
                              Select
                            </Text>
                          </TouchableOpacity>
                        </View>
                  ...
                  <View style={styles.pickerOptions}>
                    {GENDER_OPTIONS.map(option => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.pickerOption,
                          editedData.gender === option.value &&
                  ...
                  >
                    <Text style={styles.pickerText}>
                      {editedData.gender === 'Not specified'
                        ? 'Select Gender'
                        : GENDER_OPTIONS.find(
                            g => g.value === editedData.gender,
                          )?.label || editedData.gender}
                    </Text>
                    <Icon
                      name="chevron-down"
                      size={20}
