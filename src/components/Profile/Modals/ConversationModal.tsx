          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.statesContainer}>
              {CONVERSATION_STATES.map((state) => {
                const isSelected = state.id === conversationState.conversationMode;
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      { borderColor: isSelected ? state.color : theme.colors.border }
                    ]}
                  ...
                  >
                    ...
                    {isSelected && (
                      <Icon name="checkmark-circle" size={24} color={state.color} />
                    )}
                  </TouchableOpacity>
                );
              })}
