# Build Summary - v1.7.0 (Version Code 81)

## Build Information
- **Version Name**: 1.7.0
- **Version Code**: 81
- **Build Date**: 2025-10-28 00:57
- **Build Type**: Release (AAB & APK)

## File Sizes
- **AAB File**: 26.87 MB (`Whispr_v1.7.0_v81_2025-2025-10-28_00-57.aab`)
- **APK File**: 54.28 MB (`Whispr_v1.7.0_v81_2025-2025-10-28_00-57.apk`)
...
- All previous improvements (v1.5.8) included
