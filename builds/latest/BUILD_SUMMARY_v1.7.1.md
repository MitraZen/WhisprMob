# Build Summary - v1.7.1 (Version Code 82)

## Build Information
- **Version Name**: 1.7.1
- **Version Code**: 82
- **Build Date**: 2025-10-28 01:18
- **Build Type**: Release (AAB & APK)

## File Sizes
- **AAB File**: 26.87 MB (`Whispr_v1.7.1_v82_2025-2025-10-28_01-18.aab`)
- **APK File**: 54.28 MB (`Whispr_v1.7.1_v82_2025-2025-10-28_01-18.apk`)
...
- Version code incremented to 82
- All previous improvements (v1.5.8, v1.7.0) included
