# Build Summary - v1.7.3 (Version Code 84)

## Build Information
- **Version Name**: 1.7.3
- **Version Code**: 84
- **Build Date**: 2025-10-28 01:52
- **Build Type**: Release (AAB & APK)

## File Sizes
- **AAB File**: 26.87 MB (`Whispr_v1.7.3_v84_2025-2025-10-28_01-52.aab`)
- **APK File**: 54.28 MB (`Whispr_v1.7.3_v84_2025-2025-10-28_01-52.apk`)
...
- **Previous Version**: 1.7.2 (Code 83)
- **Previous Build Date**: 2025-10-28 01:29
