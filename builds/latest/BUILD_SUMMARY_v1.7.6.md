# Build Summary - v1.7.6 (Version Code 87)

## Build Information
- **Version Name**: 1.7.6
- **Version Code**: 87
- **Build Date**: 2025-10-28 02:08
- **Build Type**: Release (AAB & APK)

## File Sizes
- **AAB File**: 26.87 MB (`Whispr_v1.7.6_v87_2025-2025-10-28_02-08.aab`)
- **APK File**: 54.28 MB (`Whispr_v1.7.6_v87_2025-2025-10-28_02-08.apk`)
...
- **Previous Version**: 1.7.5 (Code 86)
- **Previous Build Date**: 2025-10-28 02:03
