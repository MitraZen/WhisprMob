# Build Summary - v1.7.5 (Version Code 86)

## Build Information
- **Version Name**: 1.7.5
- **Version Code**: 86
- **Build Date**: 2025-10-28 02:03
- **Build Type**: Release (AAB & APK)

## File Sizes
- **AAB File**: 26.87 MB (`Whispr_v1.7.5_v86_2025-2025-10-28_02-03.aab`)
- **APK File**: 54.28 MB (`Whispr_v1.7.5_v86_2025-2025-10-28_02-03.apk`)
...
- **Previous Version**: 1.7.4 (Code 85)
- **Previous Build Date**: 2025-10-28 01:59
